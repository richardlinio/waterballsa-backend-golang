...
import (
	...
	"github.com/richardlinio/waterballsa-backend-golang/internal/infrastructure/database"
	...
	"github.com/richardlinio/waterballsa-backend-golang/internal/infrastructure/server"
	"github.com/richardlinio/waterballsa-backend-golang/internal/job"
...
func New() (*Application, error) {
	...
	// Setup Gin router
	ginRouter := gin.New()
	r := router.NewRouter(ginRouter, cfg.CORS, cfg.RateLimit, cfg.JWT, log, healthHandler, authHandler, journeyHandler, missionHandler, progressHandler, jwtMiddleware, blacklistChecker)
	r.Setup()
