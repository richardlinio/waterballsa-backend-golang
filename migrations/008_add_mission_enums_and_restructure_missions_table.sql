...
-- +goose Down
ALTER TABLE missions ADD COLUMN is_free_preview BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE missions ADD COLUMN experience_reward INTEGER NOT NULL DEFAULT 100;
ALTER TABLE missions ADD COLUMN duration_seconds INTEGER NOT NULL DEFAULT 0;
ALTER TABLE missions ADD COLUMN video_url VARCHAR(500) NOT NULL DEFAULT '';
DROP INDEX IF EXISTS idx_missions_access_level;
ALTER TABLE missions DROP COLUMN access_level;
ALTER TABLE missions DROP COLUMN description;
