...
-- +goose Down
ALTER INDEX idx_resources_mission_order RENAME TO idx_contents_mission_order;
ALTER INDEX idx_resources_mission_id RENAME TO idx_contents_mission_id;
ALTER TABLE mission_resources RENAME CONSTRAINT fk_resources_mission TO fk_contents_mission;
ALTER TABLE mission_resources DROP COLUMN resource_content;
ALTER TABLE mission_resources ALTER COLUMN resource_url SET NOT NULL;
ALTER TABLE mission_resources RENAME COLUMN resource_url TO content_url;
ALTER TABLE mission_resources RENAME COLUMN resource_type TO content_type;
ALTER TABLE mission_resources RENAME TO mission_contents;
ALTER TYPE resource_type RENAME TO content_type;
