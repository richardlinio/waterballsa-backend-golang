...
-- +goose Down
UPDATE mission_resources SET resource_url = 'https://youtu.be/iJHzesWhDj0' WHERE id = 1;
UPDATE mission_resources SET resource_url = 'https://youtu.be/upAg_4p-6p8' WHERE id = 2;
UPDATE mission_resources SET resource_url = 'https://youtu.be/1wODH0FT3pM' WHERE id = 3;
UPDATE mission_resources SET resource_url = 'https://youtu.be/A99IECKCJF8' WHERE id = 4;
UPDATE mission_resources SET resource_url = 'https://youtu.be/NBcP5XPgcUo' WHERE id = 5;
