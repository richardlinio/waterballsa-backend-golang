-- +goose Up
-- Add slug column to journeys table for URL-friendly identifiers
...
-- +goose Down
DROP INDEX IF EXISTS idx_journeys_slug;
ALTER TABLE journeys DROP CONSTRAINT IF EXISTS uk_journeys_slug;
ALTER TABLE journeys DROP COLUMN slug;
